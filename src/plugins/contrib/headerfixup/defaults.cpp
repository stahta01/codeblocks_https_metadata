...
void Bindings::SetDefaultsSTL()
{
  ...
  AddBinding(_T("STL"),_T("all_of"),                             _T("algorithm"));
  AddBinding(_T("STL"),_T("any_of"),                             _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("copy_if"),                            _T("algorithm"));
  AddBinding(_T("STL"),_T("copy_n"),                             _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("find_if_not"),                        _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("is_heap"),                            _T("algorithm"));
  AddBinding(_T("STL"),_T("is_heap_until"),                      _T("algorithm"));
  AddBinding(_T("STL"),_T("is_partitioned"),                     _T("algorithm"));
  AddBinding(_T("STL"),_T("is_permutation"),                     _T("algorithm"));
  AddBinding(_T("STL"),_T("is_sorted"),                          _T("algorithm"));
  AddBinding(_T("STL"),_T("is_sorted_until"),                    _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("minmax"),                             _T("algorithm"));
  AddBinding(_T("STL"),_T("minmax_element"),                     _T("algorithm"));
  AddBinding(_T("STL"),_T("min_element"),                        _T("algorithm"));
  AddBinding(_T("STL"),_T("mismatch"),                           _T("algorithm"));
  AddBinding(_T("STL"),_T("move"),                               _T("algorithm"));
  AddBinding(_T("STL"),_T("move_backward"),                      _T("algorithm"));
  AddBinding(_T("STL"),_T("next_permutation"),                   _T("algorithm"));
  AddBinding(_T("STL"),_T("none_of"),                            _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("partition_copy"),                     _T("algorithm"));
  AddBinding(_T("STL"),_T("partition_point"),                    _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("shuffle"),                            _T("algorithm"));
  ...
  AddBinding(_T("STL"),_T("array"),                              _T("array"));
  AddBinding(_T("STL"),_T("bitset"),                             _T("bitset"));
  AddBinding(_T("STL"),_T("codecvt_mode"),                       _T("codecvt"));
  AddBinding(_T("STL"),_T("codecvt_utf16"),                      _T("codecvt"));
  AddBinding(_T("STL"),_T("codecvt_utf8"),                       _T("codecvt"));
  AddBinding(_T("STL"),_T("codecvt_utf8_utf16"),                 _T("codecvt"));
  ...
  AddBinding(_T("STL"),_T("proj"),                               _T("complex"));
  AddBinding(_T("STL"),_T("real"),                               _T("complex"));
  AddBinding(_T("STL"),_T("deque"),                              _T("deque"));
  AddBinding(_T("STL"),_T("bad_exception"),                      _T("exception"));
  AddBinding(_T("STL"),_T("current_exception"),                  _T("exception"));
  AddBinding(_T("STL"),_T("exception"),                          _T("exception"));
  AddBinding(_T("STL"),_T("exception_ptr"),                      _T("exception"));
  AddBinding(_T("STL"),_T("get_terminate"),                      _T("exception"));
  AddBinding(_T("STL"),_T("get_unexpected"),                     _T("exception"));
  AddBinding(_T("STL"),_T("make_exception_ptr"),                 _T("exception"));
  AddBinding(_T("STL"),_T("nested_exception"),                   _T("exception"));
  AddBinding(_T("STL"),_T("rethrow_exception"),                  _T("exception"));
  AddBinding(_T("STL"),_T("rethrow_if_nested"),                  _T("exception"));
  ...
  AddBinding(_T("STL"),_T("throw_with_nested"),                  _T("exception"));
  ...
  AddBinding(_T("STL"),_T("forward_list"),                       _T("forward_list"));
  ...
  AddBinding(_T("STL"),_T("bit_and"),                            _T("functional"));
  AddBinding(_T("STL"),_T("bit_not"),                            _T("functional"));
  AddBinding(_T("STL"),_T("bit_or"),                             _T("functional"));
  AddBinding(_T("STL"),_T("bit_xor"),                            _T("functional"));
  AddBinding(_T("STL"),_T("cref"),                               _T("functional"));
  ...
  AddBinding(_T("STL"),_T("function"),                           _T("functional"));
  AddBinding(_T("STL"),_T("greater"),                            _T("functional"));
  AddBinding(_T("STL"),_T("greater_equal"),                      _T("functional"));
  AddBinding(_T("STL"),_T("hash"),                               _T("functional"));
  AddBinding(_T("STL"),_T("is_bind_expression"),                 _T("functional"));
  AddBinding(_T("STL"),_T("is_placeholder"),                     _T("functional"));
  ...
  AddBinding(_T("STL"),_T("mem_fn"),                             _T("functional"));
  ...
  AddBinding(_T("STL"),_T("ref"),                                _T("functional"));
  AddBinding(_T("STL"),_T("reference_wrapper"),                  _T("functional"));
  ...
  AddBinding(_T("STL"),_T("boolalpha"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("dec"),                                _T("iomanip"));
  AddBinding(_T("STL"),_T("defaultfloat"),                       _T("iomanip"));
  AddBinding(_T("STL"),_T("get_money"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("get_time"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("fixed"),                              _T("iomanip"));
  AddBinding(_T("STL"),_T("hex"),                                _T("iomanip"));
  AddBinding(_T("STL"),_T("hexfloat"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("internal"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("left"),                               _T("iomanip"));
  AddBinding(_T("STL"),_T("noboolalpha"),                        _T("iomanip"));
  AddBinding(_T("STL"),_T("noshowbase"),                         _T("iomanip"));
  AddBinding(_T("STL"),_T("noshowpoint"),                        _T("iomanip"));
  AddBinding(_T("STL"),_T("noshowpos"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("noskipws"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("nounitbuf"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("nouppercase"),                        _T("iomanip"));
  AddBinding(_T("STL"),_T("oct"),                                _T("iomanip"));
  AddBinding(_T("STL"),_T("put_money"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("put_time"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("quoted"),                             _T("iomanip"));
  AddBinding(_T("STL"),_T("resetiosflags"),                      _T("iomanip"));
  AddBinding(_T("STL"),_T("right"),                              _T("iomanip"));
  AddBinding(_T("STL"),_T("scientific"),                         _T("iomanip"));
  ...
  AddBinding(_T("STL"),_T("showbase"),                           _T("iomanip"));
  AddBinding(_T("STL"),_T("showpoint"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("showpos"),                            _T("iomanip"));
  AddBinding(_T("STL"),_T("skipws"),                             _T("iomanip"));
  AddBinding(_T("STL"),_T("unitbuf"),                            _T("iomanip"));
  AddBinding(_T("STL"),_T("uppercase"),                          _T("iomanip"));
  AddBinding(_T("STL"),_T("initializer_list"),                   _T("initializer_list"));
  ...
  AddBinding(_T("STL"),_T("ws"),                                 _T("istream"));
  ...
  AddBinding(_T("STL"),_T("begin"),                              _T("iterator"));
  AddBinding(_T("STL"),_T("bidirectional_iterator_tag"),         _T("iterator"));
  AddBinding(_T("STL"),_T("cbegin"),                             _T("iterator"));
  AddBinding(_T("STL"),_T("cend"),                               _T("iterator"));
  AddBinding(_T("STL"),_T("checked_array_iterator"),             _T("iterator"));
  AddBinding(_T("STL"),_T("crbegin"),                            _T("iterator"));
  AddBinding(_T("STL"),_T("crend"),                              _T("iterator"));
  AddBinding(_T("STL"),_T("distance"),                           _T("iterator"));
  AddBinding(_T("STL"),_T("end"),                                _T("iterator"));
  ...
  AddBinding(_T("STL"),_T("make_reverse_iterator"),              _T("iterator"));
  AddBinding(_T("STL"),_T("move_iterator"),                      _T("iterator"));
  AddBinding(_T("STL"),_T("next"),                               _T("iterator"));
  ...
  AddBinding(_T("STL"),_T("prev"),                               _T("iterator"));
  AddBinding(_T("STL"),_T("random_access_iterator_tag"),         _T("iterator"));
  AddBinding(_T("STL"),_T("rbegin"),                             _T("iterator"));
  AddBinding(_T("STL"),_T("rend"),                               _T("iterator"));
  ...
  AddBinding(_T("STL"),_T("has_facet"),                          _T("locale"));
  ...
  AddBinding(_T("STL"),_T("time_get_byname"),                    _T("locale"));
  AddBinding(_T("STL"),_T("time_put"),                           _T("locale"));
  AddBinding(_T("STL"),_T("time_put_byname"),                    _T("locale"));
  AddBinding(_T("STL"),_T("use_facet"),                          _T("locale"));
  AddBinding(_T("STL"),_T("wbuffer_convert"),                    _T("locale"));
  AddBinding(_T("STL"),_T("wstring_convert"),                    _T("locale"));
  AddBinding(_T("STL"),_T("map"),                                _T("map"));
  AddBinding(_T("STL"),_T("multimap"),                           _T("map"));
  AddBinding(_T("STL"),_T("value_compare"),                      _T("map"));
  AddBinding(_T("STL"),_T("addressof"),                          _T("memory"));
  AddBinding(_T("STL"),_T("align"),                              _T("memory"));
  AddBinding(_T("STL"),_T("allocate_shared"),                    _T("memory"));
  AddBinding(_T("STL"),_T("allocator"),                          _T("memory"));
  AddBinding(_T("STL"),_T("allocator_arg"),                      _T("memory"));
  AddBinding(_T("STL"),_T("allocator_arg_t"),                    _T("memory"));
  AddBinding(_T("STL"),_T("allocator_traits"),                   _T("memory"));
  AddBinding(_T("STL"),_T("auto_ptr"),                           _T("memory"));
  AddBinding(_T("STL"),_T("bad_weak_ptr"),                       _T("memory"));
  AddBinding(_T("STL"),_T("const_pointer_cast"),                 _T("memory"));
  AddBinding(_T("STL"),_T("checked_uninitialized_fill_n"),       _T("memory"));
  AddBinding(_T("STL"),_T("declare_no_pointers"),                _T("memory"));
  AddBinding(_T("STL"),_T("declare_reachable"),                  _T("memory"));
  AddBinding(_T("STL"),_T("default_delete"),                     _T("memory"));
  AddBinding(_T("STL"),_T("dynamic_pointer_cast"),               _T("memory"));
  AddBinding(_T("STL"),_T("enable_shared_from_this"),            _T("memory"));
  AddBinding(_T("STL"),_T("get_deleter"),                        _T("memory"));
  AddBinding(_T("STL"),_T("get_pointer_safety"),                 _T("memory"));
  AddBinding(_T("STL"),_T("get_temporary_buffer"),               _T("memory"));
  AddBinding(_T("STL"),_T("make_unique"),                        _T("memory"));
  AddBinding(_T("STL"),_T("make_shared"),                        _T("memory"));
  AddBinding(_T("STL"),_T("owner_less"),                         _T("memory"));
  AddBinding(_T("STL"),_T("pointer_safety"),                     _T("memory"));
  AddBinding(_T("STL"),_T("pointer_traits"),                     _T("memory"));
  AddBinding(_T("STL"),_T("raw_storage_iterator"),               _T("memory"));
  AddBinding(_T("STL"),_T("return_temporary_buffer"),            _T("memory"));
  AddBinding(_T("STL"),_T("shared_ptr"),                         _T("memory"));
  AddBinding(_T("STL"),_T("static_pointer_cast"),                _T("memory"));
  AddBinding(_T("STL"),_T("unchecked_uninitialized_fill_n"),     _T("memory"));
  AddBinding(_T("STL"),_T("undeclare_no_pointers"),              _T("memory"));
  AddBinding(_T("STL"),_T("undeclare_reachable"),                _T("memory"));
  AddBinding(_T("STL"),_T("uninitialized_copy"),                 _T("memory"));
  AddBinding(_T("STL"),_T("uninitialized_copy_n"),               _T("memory"));
  AddBinding(_T("STL"),_T("uninitialized_fill"),                 _T("memory"));
  AddBinding(_T("STL"),_T("uninitialized_fill_n"),               _T("memory"));
  AddBinding(_T("STL"),_T("unique_ptr"),                         _T("memory"));
  AddBinding(_T("STL"),_T("uses_allocator"),                     _T("memory"));
  AddBinding(_T("STL"),_T("weak_ptr"),                           _T("memory"));
  AddBinding(_T("STL"),_T("bad_alloc"),                          _T("new"));
  AddBinding(_T("STL"),_T("bad_array_new_length"),               _T("new"));
  AddBinding(_T("STL"),_T("new_handler"),                        _T("new"));
  AddBinding(_T("STL"),_T("nothrow"),                            _T("new"));
  AddBinding(_T("STL"),_T("nothrow_t"),                          _T("new"));
  AddBinding(_T("STL"),_T("get_new_handler"),                    _T("new"));
  AddBinding(_T("STL"),_T("set_new_handler"),                    _T("new"));
  ...
  AddBinding(_T("STL"),_T("iota"),                               _T("numeric"));
  ...
  AddBinding(_T("STL"),_T("endl"),                               _T("ostream"));
  AddBinding(_T("STL"),_T("ends"),                               _T("ostream"));
  AddBinding(_T("STL"),_T("flush"),                              _T("ostream"));
  ...
  AddBinding(_T("STL"),_T("bernouilli_distribution"),            _T("random"));
  AddBinding(_T("STL"),_T("binomial_distribution"),              _T("random"));
  AddBinding(_T("STL"),_T("cauchy_distribution"),                _T("random"));
  AddBinding(_T("STL"),_T("chi_squared_distribution"),           _T("random"));
  AddBinding(_T("STL"),_T("default_random_engine"),              _T("random"));
  AddBinding(_T("STL"),_T("discard_block_engine"),               _T("random"));
  AddBinding(_T("STL"),_T("discrete_distribution"),              _T("random"));
  AddBinding(_T("STL"),_T("exponential_distribution"),           _T("random"));
  AddBinding(_T("STL"),_T("extreme_value_distribution"),         _T("random"));
  AddBinding(_T("STL"),_T("fisher_f_distribution"),              _T("random"));
  AddBinding(_T("STL"),_T("gamma_distribution"),                 _T("random"));
  AddBinding(_T("STL"),_T("generate_canonical"),                 _T("random"));
  AddBinding(_T("STL"),_T("geometric_distribution"),             _T("random"));
  AddBinding(_T("STL"),_T("independent_bits_engine"),            _T("random"));
  AddBinding(_T("STL"),_T("knuth_b"),                            _T("random"));
  AddBinding(_T("STL"),_T("linear_congruential_engine"),         _T("random"));
  AddBinding(_T("STL"),_T("lognormal_distribution"),             _T("random"));
  AddBinding(_T("STL"),_T("mersenne_twister_engine"),            _T("random"));
  AddBinding(_T("STL"),_T("minstd_rand"),                        _T("random"));
  AddBinding(_T("STL"),_T("minstd_rand0"),                       _T("random"));
  AddBinding(_T("STL"),_T("mt19937"),                            _T("random"));
  AddBinding(_T("STL"),_T("mt19937_64"),                         _T("random"));
  AddBinding(_T("STL"),_T("negative_binomial_distribution"),     _T("random"));
  AddBinding(_T("STL"),_T("normal_distribution"),                _T("random"));
  AddBinding(_T("STL"),_T("piecewise_constant_distribution"),    _T("random"));
  AddBinding(_T("STL"),_T("piecewise_linear_distribution"),      _T("random"));
  AddBinding(_T("STL"),_T("poisson_distribution"),               _T("random"));
  AddBinding(_T("STL"),_T("ranlux24"),                           _T("random"));
  AddBinding(_T("STL"),_T("ranlux48"),                           _T("random"));
  AddBinding(_T("STL"),_T("ranlux24_base"),                      _T("random"));
  AddBinding(_T("STL"),_T("ranlux48_base"),                      _T("random"));
  AddBinding(_T("STL"),_T("seed_seq"),                           _T("random"));
  AddBinding(_T("STL"),_T("student_t_distribution"),             _T("random"));
  AddBinding(_T("STL"),_T("shuffle_order_engine"),               _T("random"));
  AddBinding(_T("STL"),_T("subtract_with_carry_engine"),         _T("random"));
  AddBinding(_T("STL"),_T("uniform_int_distribution"),           _T("random"));
  AddBinding(_T("STL"),_T("uniform_real_distribution"),          _T("random"));
  AddBinding(_T("STL"),_T("weibull_distribution"),               _T("random"));
  AddBinding(_T("STL"),_T("centi"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("deca"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("deci"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("atto"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("hecto"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("exa"),                                _T("ratio"));
  AddBinding(_T("STL"),_T("femto"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("giga"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("kilo"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("mega"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("micro"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("milli"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("nano"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("peta"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("pico"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("ratio"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_add"),                          _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_divide"),                       _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_equal"),                        _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_greater"),                      _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_greater_equal"),                _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_less"),                         _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_less_equal"),                   _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_multiply"),                     _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_not_equal"),                    _T("ratio"));
  AddBinding(_T("STL"),_T("ratio_subtract"),                     _T("ratio"));
  AddBinding(_T("STL"),_T("tera"),                               _T("ratio"));
  AddBinding(_T("STL"),_T("yocto"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("yotta"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("zepto"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("zetta"),                              _T("ratio"));
  AddBinding(_T("STL"),_T("scoped_allocator_adaptor"),           _T("scoped_allocator_adaptor"));
  ...
  AddBinding(_T("STL"),_T("getline"),                            _T("string"));
  AddBinding(_T("STL"),_T("u16string"),                          _T("string"));
  AddBinding(_T("STL"),_T("u32string"),                          _T("string"));
  AddBinding(_T("STL"),_T("stod"),                               _T("string"));
  AddBinding(_T("STL"),_T("stof"),                               _T("string"));
  AddBinding(_T("STL"),_T("stoi"),                               _T("string"));
  AddBinding(_T("STL"),_T("stol"),                               _T("string"));
  AddBinding(_T("STL"),_T("stold"),                              _T("string"));
  AddBinding(_T("STL"),_T("stoll"),                              _T("string"));
  AddBinding(_T("STL"),_T("stoul"),                              _T("string"));
  AddBinding(_T("STL"),_T("stoull"),                             _T("string"));
  AddBinding(_T("STL"),_T("string"),                             _T("string"));
  AddBinding(_T("STL"),_T("to_string"),                          _T("string"));
  AddBinding(_T("STL"),_T("to_wstring"),                         _T("string"));
  ...
  AddBinding(_T("STL"),_T("tuple_element"),                      _T("tuple"));
  AddBinding(_T("STL"),_T("tuple_size"),                         _T("tuple"));
  AddBinding(_T("STL"),_T("type_index"),                         _T("typeindex"));
  AddBinding(_T("STL"),_T("bad_cast"),                           _T("typeinfo"));
  AddBinding(_T("STL"),_T("bad_typeid"),                         _T("typeinfo"));
  AddBinding(_T("STL"),_T("type_info"),                          _T("typeinfo"));
  AddBinding(_T("STL"),_T("unordered_map"),                      _T("unordered_map"));
  AddBinding(_T("STL"),_T("unordered_multimap"),                 _T("unordered_map"));
  AddBinding(_T("STL"),_T("unordered_set"),                      _T("unordered_set"));
  AddBinding(_T("STL"),_T("unordered_multiset"),                 _T("unordered_set"));
  AddBinding(_T("STL"),_T("declval"),                            _T("utility"));
  AddBinding(_T("STL"),_T("exchange"),                           _T("utility"));
  AddBinding(_T("STL"),_T("forward"),                            _T("utility"));
  AddBinding(_T("STL"),_T("index_sequence"),                     _T("utility"));
  AddBinding(_T("STL"),_T("index_sequence_for"),                 _T("utility"));
  AddBinding(_T("STL"),_T("integer_sequence"),                   _T("utility"));
  AddBinding(_T("STL"),_T("make_index_sequence"),                _T("utility"));
  AddBinding(_T("STL"),_T("make_integer_sequence"),              _T("utility"));
  AddBinding(_T("STL"),_T("move_if_noexcept"),                   _T("utility"));
  AddBinding(_T("STL"),_T("pair"),                               _T("utility"));
  AddBinding(_T("STL"),_T("piecewise_construct"),                _T("utility"));
  AddBinding(_T("STL"),_T("piecewise_construct_t"),              _T("utility"));
...
void Bindings::SetDefaultsCLibrary()
{
  ...
  AddBinding(_T("C_Library"),_T("isblank"),    _T("cctype"));
