    ...
    , m_DetectionManager( currentResults )
{
	...
	m_LibsContainer->Add(StaticLine10, 1, wxEXPAND, 5);
	...
	m_LibsContainer->Add(StaticLine11, 1, wxEXPAND, 5);
	...
	m_LibsContainer->Add(StaticLine12, 1, wxEXPAND, 5);
	...
	m_LibsContainer->Add(StaticLine13, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(m_MissingDefsBtn, 1, wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(Button1, 1, wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer1->Add(FlexGridSizer2, 0, wxALL|wxEXPAND, 5);
